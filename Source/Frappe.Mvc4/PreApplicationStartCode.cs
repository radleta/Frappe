...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Frappe.Mvc.PreApplicationStartCode), "Start")]
...
namespace Frappe.Mvc
{
    ...
    public static class PreApplicationStartCode
    {
        ...
        public static void Start()
        {
            ...
            DynamicModuleUtility.RegisterModule(typeof(Frappe.Sprites.SpriteModule));
